...
def main(args):
    ...
    TEST_DATASET = PartNormalDataset(root=root, npoints=args.num_point, split='test', use_normals=args.normal)
    ...
    classifier = MODEL.get_model(num_part, use_normals=args.normal).cuda()
