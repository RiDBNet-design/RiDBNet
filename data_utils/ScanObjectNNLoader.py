...
from models.RiDBNet_utils import furthest_point_sample
from models.RiDBNet_utils import compute_LRA
from models.RiDBNet_utils import index_points
from models.RiDBNet_utils import pc_normalize
...
class ScanObjectNN(Dataset):
    def __init__(self, root, args, split='train'):
        ...
        if self.uniform:
            ...
            fps_idx = furthest_point_sample(self.points_, self.num_points)
    ...
    def __getitem__(self, idx):
        ...
        #current_points[:,:3] = translate_pointcloud(current_points[:,:3])
